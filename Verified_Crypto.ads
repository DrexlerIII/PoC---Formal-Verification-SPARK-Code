...
package body Verified_Crypto with SPARK_Mode is
   ...
   S_Box : constant array (Unsigned_8) of Unsigned_8 := 
     (16#63#, 16#7C#, 16#77#, 16#7B#, 16#F2#, 16#6B#, 16#6F#, 16#C5#, 16#30#, 16#01#, 16#67#, 16#2B#, 16#FE#, 16#D7#, 16#AB#, 16#76#,
      ...
      16#E7#, 16#C8#, 16#37#, 16#6D#, 16#8D#, 16#15#, 16#4E#, 16#A9#, 16#6C#, 16#56#, 16#F4#, 16#EA#, 16#65#, 16#7A#, 16#AE#, 16#08#,
      ...
      16#E1#, 16#F8#, 16#98#, 16#11#, 16#69#, 16#13#, 16#8E#, 16#94#, 16#9B#, 16#1E#, 16#87#, 16#E9#, 16#CE#, 16#55#, 16#28#, 16#DF#,
      16#8C#, 16#A1#, 16#89#, 16#0D#, 16#BF#, 16#E6#, 16#42#, 16#68#, 16#41#, 16#99#, 16#2D#, 16#0F#, 16#B0#, 16#54#, 16#BB#, 16#16#);

   ---------------------------------------------------------------------------
   function Sub_Byte (Input : Unsigned_8) return Unsigned_8 is
   begin
      return S_Box(Input);
   end Sub_Byte;
   ...
   begin
      for I in Block'Range loop
         -- XOR with the key, then substitute. 
         -- We use K_Idx to safely wrap around the 32-byte key.
         Ciphertext(I) := Sub_Byte(Plaintext(I) xor Key(K_Idx));
         
         -- Cycle the key index (0..31)
         K_Idx := (K_Idx + 1) mod 32;
      end loop;
   end Encrypt_Block;
